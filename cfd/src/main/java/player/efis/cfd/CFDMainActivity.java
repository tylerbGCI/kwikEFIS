...
public class CFDMainActivity extends EFISMainActivity implements Listener, SensorEventListener, LocationListener
{
    public static final String PREFS_NAME = R.string.app_name + ".prefs";
    private CFDSurfaceView mGLView;
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        switch (item.getItemId()) {
            case R.id.settings:
                ...
                Intent i = new Intent(this, CFDPrefSettings.class);
                startActivity(i);
                break;
            case R.id.manage:
                // Launch manage activity
                Intent j = new Intent(this, CFDPrefManage.class);
                startActivity(j);
                break;
            case R.id.quit:
                // Quit the app
